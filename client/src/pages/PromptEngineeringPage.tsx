...
import { ArrowRight, CheckCircle, Sparkles, Lightbulb, Image, Video, FileText, Zap, ChevronDown, BookOpen } from "lucide-react";
          ...
          <div className="max-w-4xl mx-auto text-center text-white">
            ...
            >
              <h2 className="text-3xl md:text-4xl font-bold mb-4">
                Quer dominar Prompt Engineering no seu time?
              </h2>
